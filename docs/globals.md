...
- [ClearWebhooksQueueResponse](interfaces/ClearWebhooksQueueResponse.md)
...
- [GetWebhooksCountResponse](interfaces/GetWebhooksCountResponse.md)
...
- [IncomingBlockWebhook](interfaces/IncomingBlockWebhook.md)
- [IncomingCall](interfaces/IncomingCall.md)
...
- [InteractiveButton](interfaces/InteractiveButton.md)
- [InteractiveButtonReply](interfaces/InteractiveButtonReply.md)
...
- [OutgoingCall](interfaces/OutgoingCall.md)
- [OutgoingCallParticipant](interfaces/OutgoingCallParticipant.md)
...
- [StateInstanceHistoryItem](interfaces/StateInstanceHistoryItem.md)
...
- [UpdateApiTokenResponse](interfaces/UpdateApiTokenResponse.md)
...
- [UpdateGroupSettingsResponse](interfaces/UpdateGroupSettingsResponse.md)
...
- [IncomingCallStatus](type-aliases/IncomingCallStatus.md)
...
- [InteractiveButtonType](type-aliases/InteractiveButtonType.md)
...
- [OutgoingCallStatus](type-aliases/OutgoingCallStatus.md)
